              ...
              {items.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <Link to={`/products/${item.productSlug}`} className="font-semibold text-gray-900 text-sm hover:text-indigo-600 transition line-clamp-2">
                      {item.productName}
                    </Link>
                    {item.variantLabel && (
              ...
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 leading-relaxed">
                    Sign in or create a customer account to complete your purchase and track your orders.
                  </p>
                </div>
                <button
