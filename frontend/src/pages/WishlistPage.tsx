          ...
          <AnimatePresence>
            {items.map((item) => {
              ...
              return (
                ...
                >
                  <Link to={`/products/${item.productSlug}`} className="relative block aspect-square bg-gray-50 overflow-hidden">
                    {item.imageUrl ? (
                  ...
                  <div className="p-3 flex flex-col flex-1">
                    <Link to={`/products/${item.productSlug}`} className="text-sm font-semibold text-gray-800 hover:text-indigo-600 transition line-clamp-2 flex-1">
                      {item.productName}
                    </Link>
