      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/10">
          <Link to="/admin/dashboard" className="block">
            <img src={logo} alt="Mattress Factory" className="brightness-0 invert w-[110px] lg:w-[140px]" />
          </Link>
      ...
      <div className="lg:ml-64 flex flex-col flex-1">
        ...
        <footer className="bg-white border-t border-gray-200 px-6 py-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-2">
            <div className="flex items-center gap-3">
              <img src={logo} alt="Mattress Factory" className="w-[70px] md:w-[100px]" />
              <span className="text-xs text-gray-400">Admin Panel</span>
            </div>
            <p className="text-xs text-gray-400 text-center">
              © {new Date().getFullYear()} Mattress Factory. All rights reserved. &nbsp;|&nbsp;
              <Link to="/" className="hover:text-[#1a2a6c] transition-colors">Visit Store</Link>
            </p>
